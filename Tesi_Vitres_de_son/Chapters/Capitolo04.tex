...
Forma tripartita. dall'alto in basso: figure ritmiche, soundscapes ed elettronica.
 ...
 \begin{figure}[htbp]
        \centering
        \includegraphics[height=22cm, width=28cm, angle=0,
          keepaspectratio]{Macroforma01.png}
\end{figure}
