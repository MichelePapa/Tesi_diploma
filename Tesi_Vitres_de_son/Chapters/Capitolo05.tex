...
Di seguito, l'analisi spettrale e lo spettrogramma della risposta all'eccitazione di ogni singola molla. Sottolineo che l'eccitazione della molla, avviene nella parte centrale. \\
 ...
 \begin{figure}[htbp]
        \centering
        \includegraphics[height=8cm, width=15cm,
          keepaspectratio]{MOLLA1.jpg}
\end{figure}

 \begin{figure}[htbp]
        \centering
        \includegraphics[height=10cm, width=15cm,
          keepaspectratio]{MOLLA2.jpg}
\end{figure}

 \begin{figure}[htbp]
        \centering
        \includegraphics[height=9cm, width=15cm,
          keepaspectratio]{MOLLA2.jpg}
\end{figure}

 \begin{figure}[htbp]
        \centering
        \includegraphics[height=6cm, width=15cm,
          keepaspectratio]{MOLLA3.jpg}
\end{figure}

 \begin{figure}[htbp]
        \centering
        \includegraphics[height=8cm, width=15cm,
          keepaspectratio]{MOLLA4.jpg}
\end{figure}
